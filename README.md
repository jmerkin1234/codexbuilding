...
- Cushion and jaw calibration now includes endpoint fields plus direct `Mid X`, `Mid Y`, and angle fields, so a line segment can be moved as a whole and then rotated without manually dragging both endpoints.
